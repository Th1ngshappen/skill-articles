...
class ProfileFragment : BaseFragment<ProfileViewModel>() {
    ...
    override val binding: ProfileBinging by lazy { ProfileBinging() }
    ...
    private fun updateAvatar(avatarUrl: String) {
        // TODO обработать загрузку, удаление, изменение текущего аватара
        // TODO check if .apply(circleCropTransform()) & .override(size) are needed
        Glide.with(requireContext())
            .load(avatarUrl)
            .into(iv_avatar)
    }

    inner class ProfileBinging : Binding() {
