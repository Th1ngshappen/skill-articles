...
class MarkdownCodeView private constructor(
    ...
    init {
        tv_codeView = MarkdownTextView(context, fontSize * 0.85f).apply {
            ...
            // чтобы вью могла захватывать фокус внутри скролла
            isFocusable = true
        ...
        sv_scroll = object : HorizontalScrollView(context) {
            override fun getLeftFadingEdgeStrength(): Float {
                return 0f // 1 - fade, 0 - do not fade
            }
        }.apply {
            overScrollMode = View.OVER_SCROLL_NEVER
            isHorizontalFadingEdgeEnabled = true // полупрозрачная тень на правой части code вью
    ...
    public override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        if (isSingleLine) {
            val iconHeight = (b - t - iconSize) / 2 // позиция иконки по оси y
