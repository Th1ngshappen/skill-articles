...
class ToolbarBuilder() {
    ...
    fun build(context: FragmentActivity) {
        ...
        // показать аппбар, если вернулись с нескроллируемого объекта
...
class BottombarBuilder() {
    ...
    // коллекция id лайаутов, которые мы хотим заинфлейтить в корневой вью
    ...
    fun build(context: FragmentActivity) {
        ...
        with(context.nav_view) {
            ...
            // показать боттомбар, если вернулись с нескроллируемого объекта
